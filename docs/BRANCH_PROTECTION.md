...
| -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `Policy, lint, contract, tests, build` | TypeScript, a credential-shaped string, unformatted code, a lint error, a contract that does not validate, a failing test, an undeclared skipped test, a database that will not migrate from empty or from populated, a failing build, OpenAPI or route-manifest drift, a server-only name in the browser bundle, a vulnerable dependency, a reachable production payment path |
